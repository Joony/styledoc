(function(jQuery){
  ...
  var lang = [
    ...
    'Unknown section',
    'Generated by Styledoc',
    'Fork Styledoc on Github'
  ];
  ...
  var _Styledoc = function(obj,elem,settings){
    ...
    this.footer = $('<div class="styledoc-footer">' + lang[5] + ' <a href="https://github.com/Joony/styledoc">' + lang[6] + '</a></div>');
    ...
    // Insert to the DOM
    $(elem).addClass('styledoc').append(this.header.text(this.title)).append(this.content).append(this.navigation).append(this.footer);
